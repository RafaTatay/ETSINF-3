    ...
    switch (ID_EX.IR.codop) {
        ...
        default: /* el resto de instrucciones */
            ...
            switch (solucion_riesgos_datos) {
              ...
              if(MEM_WB.IR.Rdestino == ID_EX.IR.Rfuente1 && escribe_Rdst(MEM_WB.IR) && lee_Rfte1(ID_EX.IR) ){
                ...
                if( EX_MEM.IR.Rdestino == ID_EX.IR.Rfuente1 && escribe_Rdst(MEM_WB.IR) && lee_Rfte1(ID_EX.IR) ){
...
void detectar_riesgos_datos(void) {
    ...
    switch (solucion_riesgos_datos) {
        case parada:
            ...
            if((ID_EX.IR.Rdestino == IF_ID.IR.Rfuente1) && lee_Rfte1(IF_ID.IR) && escribe_Rdst(ID_EX.IR) ){
                IFstall = SI;
                IDstall = SI; 
            ...
            if( (ID_EX.IR.Rdestino == IF_ID.IR.Rfuente2) && lee_Rfte2(IF_ID.IR) && escribe_Rdst(ID_EX.IR) ){
             ...
             */
              ...
              /* INSERTAR CÓDIGO */
            if((EX_MEM.IR.Rdestino == IF_ID.IR.Rfuente1)  
                && lee_Rfte1(IF_ID.IR) 
                && escribe_Rdst(EX_MEM.IR) ){
            ...
            if( (EX_MEM.IR.Rdestino == IF_ID.IR.Rfuente2) //Mira si hay conflictpo
                && lee_Rfte2(IF_ID.IR) //Comprueba si existe el registro fuente2
                && escribe_Rdst(EX_MEM.IR) ){ //Verifica que hay un destino valido en la fase EX
                IFstall = SI;
                IDstall = SI; 
        ...
        case cortocircuito:
             ...
             */
              ...
              /* INSERTAR CÓDIGO */
            if((ID_EX.IR.Rdestino == IF_ID.IR.Rfuente1) && lee_Rfte1(IF_ID.IR) && escribe_Rdst(ID_EX.IR) && inst_load(IF_ID.IR)){
                IFstall = SI;
                IDstall = SI; 
            ...
            if( (ID_EX.IR.Rdestino == IF_ID.IR.Rfuente2) && lee_Rfte2(IF_ID.IR) && escribe_Rdst(ID_EX.IR) && inst_load(IF_ID.IR) ){
